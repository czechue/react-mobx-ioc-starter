...
export type InjectConfig = Record<
  string,
  ...
  return {
    ...
    InjectionProvider: class InjectionProvider extends React.Component<ProviderProps> {
      ...
      public override render() {
        return (
          <Provider value={this.props.container}>
            {this.props.children}
          </Provider>
        );
      }
    ...
    injectComponent<TInject, TStateMap = {}>(
      ...
      type RemoveInjectedProps<TBase> = Omit<
        TBase,
        keyof Shared<TInject & TStateMap, TBase>
      > & { container?: Container };
      ...
      return function <TBaseProps>(
        ...
        const injector = class extends Component<
          RemoveInjectedProps<TBaseProps>
        > {
            ...
            return (
              <Consumer>
                {(container) => {
                  ...
                  for (const key of Object.keys(inject) as Array<
                    keyof typeof inject
                  >) {
